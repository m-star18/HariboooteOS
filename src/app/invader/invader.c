...
void HariMain(void) {
    int win, timer, fx, laserwait;
    int i, j;
    int lx = 0, ly;
    int ix, iy;
    int movewait0, movewait, idir;
    int invline, score, high, point;
    char winbuf[336 * 261], invstr[32 * 6], str[12], keyflag[4], *p;
...
void putstr(int win, char *winbuf, int x, int y, int col, unsigned char *str) {
    int c, x0, i;
    char *p, *q, t[2];
    x = x * 8 + 8;
    y = y * 16 + 29;
